...
![Cover - Chapter 13](../.gitbook/assets/chapter-13-polymorphism.jpg)
...
> “I don’t need to know _what_ it is—only that it can `makeSound()`.”
...
> The game engine doesn’t care _who_ is hit—only that they can `takeDamage()`.
