...
![Cover - Chapter 9](../.gitbook/assets/chapter-09-introduction-to-oop.jpg)
...
> Think: “What does this thing _have_? What can it _do_?”
...
1. A `Book` has a `title` and `author`. It can `describe()` itself (return “_title_ by _author_”).\
   Write the class.
...
* Start simple: identify “things” in your app, then define what they _have_ and _do_.
